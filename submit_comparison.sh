#!/bin/sh
#SBATCH --job-name=linN768z49
#SBATCH -o /home/aubin/data/BullFrog/comparison_article/logs/linN768z49.out
#SBATCH -e /home/aubin/data/BullFrog/comparison_article/logs/linN768z49.err
#SBATCH -N 1                                    # Number of nodes (value or min-max)
#SBATCH -n 64                                   # The number of tasks (i.e. cores) per node
#SBATCH --time=0:20:00                         # Runtime in D-HH:MM, min 10 minutes
